...
- Do not describe `statements/raw/` as a finished import pipeline; it is the intake boundary for later workflow stories.
...
- `statements/raw/`: raw statement drop zone for future import workflows
