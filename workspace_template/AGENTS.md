...
- `.auto-bean/proposals/`: optional proposal documents for riskier or review-heavy changes, including import-derived account structure when deeper review is needed
