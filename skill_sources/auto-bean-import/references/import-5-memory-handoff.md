...
- Spawn a sub-agent that invokes `$auto-bean-memory` once with the artifact set, asking it to persist any reusable learning as governed memory for future import work.
